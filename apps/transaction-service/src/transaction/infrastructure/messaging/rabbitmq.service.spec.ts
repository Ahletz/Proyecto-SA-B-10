...
describe('RabbitMqService - caída de la conexión con RabbitMQ', () => {
  ...
  it('termina el proceso si el broker cierra la conexión', async () => {
    ...
    await service.publish('x.y', { eventId: 'e1', eventType: 'x.y', version: 1, timestamp: '', correlationId: 'c1', payload: {} });
